<template>
    <div class="container">
        ...
        <form enctype="multipart/form-data" @submit.prevent="submit" @keydown="form.errors.clear($event.target.name)"
            ...
            <div class="form-group" :class="{ 'has-error': form.errors.has('subtema1') }">
                ...
                <div class="col-md-6" id="subtema1">
                    ...
                    <!--</option>-->
                    <!--</select>-->
                    <multiselect name="subtema1" v-model="form.subtema1" :options="subTemaOptions" :multiple="true"
            ...
            <div class="form-group" :class="{ 'has-error': form.errors.has('subtema2') }">
                ...
                <div class="col-md-6" id="subtema2">
                    ...
                    <!--</option>-->
                    <!--</select>-->
                    <multiselect name="subtema2" v-model="form.subtema2" :options="subTemaOptions2" :multiple="true"
                                 :close-on-select="true" :clear-on-select="false" :hide-selected="false"
                                 placeholder="Escolha um"
                                 label="descricao" track-by="descricao"></multiselect>
                ...
                <div class="panel-body">
                    <div v-for="(localData, index) in form.locaisImplantacao">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input v-model="localData.dataImplantacao" type="date" name="dataImplantacao"
                                       id="dataImplantacao"
                                       class="form-control">
                            </div>
                        </div>
            ...
            <div class="form-group" :class="{ 'has-error': form.errors.has('PublicosAlvo') }">
                ...
                <div class="col-md-6" id="PublicosAlvo">
                    ...
                    <!--</option>-->
                    <!--</select>-->
                    <multiselect name="PublicosAlvo" v-model="form.PublicosAlvo" :options="publicoAlvoOptions"

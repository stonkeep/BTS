			...
			<div class="form-group" :class="{ 'has-error': form.errors.has('subtema1') }">
				...
				<div class="col-md-6" id="subtema1">
					<!--<select class="form-control" v-model="form.subtema1" name="subtema1" multiple>-->
						...
						<!--</option>-->
					<!--</select>-->
					<multiselect name="subtema1" v-model="form.subtema1" :options="subTemaOptions" :multiple="true" :close-on-select="true" :clear-on-select="false" :hide-selected="false" placeholder="Escolha um"

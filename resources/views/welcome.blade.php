...
<head>
    ...
    <meta name="author" content="Mateus Galasso" />
...
<div id="fh5co-wrapper">
    <div id="fh5co-page">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 text-right fh5co-social">
                        <a href="http://pt-br.facebook.com/FundacaoBB" class="grow"><i class="icon-facebook2"></i></a>
                        <a href="https://twitter.com/fundacaobb" class="grow"><i class="icon-twitter2"></i></a>
                        <a href="https://www.instagram.com/fundacaobb" class="grow"><i class="icon-instagram2"></i></a>
                    </div>
                </div>
            </div>
        </div>
        <header id="fh5co-header-section" class="sticky-banner">
            <div class="container">
                <div class="nav-header">
                    ...
                    <h1 id="fh5co-logo"><a href="index.html">BTS</a></h1>
                    ...
                    <nav id="fh5co-menu-wrap" role="navigation">
                        <ul class="sf-menu" id="fh5co-primary-menu">
                            ...
                            <li>
                                <a href="#" class="fh5co-sub-ddown">O que é</a>
                                <ul class="fh5co-sub-menu">
                                    <li><a href="#">Prêmio FBB de Tecnologia Social</a></li>
                                    <li><a href="#">Banco de Tecnologias Sociais</a></li>
                                    <li><a href="#">Tecnologia Social</a></li>
                                </ul>
                            </li>
                            <li>
        ...
        <div class="fh5co-hero">
            ...
            <div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style="background-image: url(images/skyscrapers.jpg);">
                <div class="desc animate-box">
                    <h2><strong>850</strong> Tecnologias <strong>certificadas</strong></h2>
                    <!--<span>HandCrafted by <a href="http://frehtml5.co/" target="_blank" class="fh5co-site-name">FreeHTML5.co</a></span>-->
                    <span><a class="btn btn-primary btn-lg" href="#">Conheça Mais</a></span>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row row-bottom-padded-md">
                    <div class="col-md-12 text-center animate-box">
                        <p><img src="images/kindergarten-2353105_1920.jpg" alt="Free HTML5 Bootstrap Template" class="img-responsive"></p>
                    </div>
                    <div class="col-md-6 text-center animate-box">
                        <p><img src="images/slum-boy-885750_1920.jpg" alt="Free HTML5 Bootstrap Template" class="img-responsive"></p>
                    </div>
                    <div class="col-md-6 text-center animate-box">
                        <p><img src="images/starfruit-230206_1920.jpg" alt="Free HTML5 Bootstrap Template" class="img-responsive"></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
        ...
        <!--</div>-->
        <!--</div>-->
        <!--&lt;!&ndash; fh5co-content-section &ndash;&gt;-->
        ...
        <div id="fh5co-blog-section" class="fh5co-section-gray">
            ...
            <div class="container">
                <div class="row row-bottom-padded-md">
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="fh5co-blog animate-box">
                            <a href="#"><img class="img-responsive" src="/images/festa%20da%20colheita%202.jpg" alt=""></a>
                            <div class="blog-text">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="fh5co-blog animate-box">
                            <a href="#"><img class="img-responsive" src="images/fotopublicocirculacao.jpg" alt=""></a>
                            <div class="blog-text">
                                <div class="prod-title">
                                    <h3><a href=""#>Medical Mission in Southern Kenya</a></h3>
                                    <span class="posted_by">Sep. 15th</span>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="fh5co-blog animate-box">
                            <a href="#"><img class="img-responsive" src="images/apoioincentivoalimentacao.jpg" alt=""></a>
                            <div class="blog-text">
                                <div class="prod-title">
                                    <h3><a href=""#>Medical Mission in Southern Kenya</a></h3>
                                    <span class="posted_by">Sep. 15th</span>
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-4 text-center animate-box">
                        <a href="#" class="btn btn-primary btn-lg">Mais Tecnologias</a>
                    </div>
                </div>

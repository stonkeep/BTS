...
@section('content')
    @php
     ...
     $tipo = 'naturezasJuridicas' ;
    @endphp
    <div id="app">
        <div>
            <a href="{{route('naturezasJuridicas.create')}}" class="btn btn-primary">NOVO</a>
        </div>
        <table id="table" data-toggle="table"
            ...
            @foreach($data as $item)
                <tr>
                    ...
                    <td><a class="btn btn-success" href="{{route('naturezasJuridicas.edit', $item->id)}}">Editar</a></td>
                </tr>
            @endforeach
            </tbody>
        </table>

        ...
        <table id="table" data-toggle="table"
            ...
            @foreach($data as $item)
                <tr>
                    ...
                    <td><a class="btn btn-danger" href="{{route('destroyPostCategorias', ['id' => $item->id])}}">Excluir</a></td>
                    <td><a class="btn btn-success" href="{{route('editPostCategorias', ['id' => $item->id])}}">Editar</a></td>
                </tr>
            @endforeach
            </tbody>
        </table>
